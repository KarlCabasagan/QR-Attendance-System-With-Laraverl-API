...
function RegistrationForm({ isLoginPage }) {
    ...
    return (
        <form action="#" className={(isLoginPage ? "hidden" : "flex") + " w-3/4 flex-col justify-center"}>
            <div className="w-full border-b-[3px] border-purple flex justify-center mb-7">
                <input type="first-name" name="first-name" placeholder="First Name" className="w-[100%] bg-transparent p-2 pb-1 text-xl focus:outline-none"/>
            </div>
            <div className="w-full border-b-[3px] border-purple flex justify-center mb-7">
                <input type="last-name" name="last-name" placeholder="Last Name" className="w-[100%] bg-transparent p-2 pb-1 text-xl focus:outline-none"/>
            </div>
            <div className="w-full border-b-[3px] border-purple flex justify-center mb-7">
